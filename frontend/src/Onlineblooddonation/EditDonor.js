...
function EditDonor() {
    ...
    const registerDonor = async () => {
        ...
        const response = await fetch(`https://online-blood-donation-backend.onrender.com/updateDonor/${id}`, requestOptions);
    ...
    const getDatabyId = async (id) => {
        const response = await fetch('https://online-blood-donation-backend.onrender.com/getDonorsbyId/' + id)
        const data = await response.json();
        setName(data.name)
