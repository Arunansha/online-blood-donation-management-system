...
function EditUser() {
    ...
    const registerUser = async () => {
        ...
        const response = await fetch(`https://online-blood-donation-backend.onrender.com/${id}`, requestOptions);
    ...
    const getDatabyId = async (id) => {
        const response = await fetch('https://online-blood-donation-backend.onrender.com/getUsersbyId/' + id)
        const data = await response.json();
        setName(data.name)
