...
function Forgotpassworddonor() {
    ...
    const validateEmail = async () => {
        ...
        const response = await fetch('https://online-blood-donation-backend.onrender.com/validateEmailDonor', requestOptions);
    ...
    const updatePassword = async () => {
        ...
        const response = await fetch('https://online-blood-donation-backend.onrender.com/updateDonorByEmail/' + email, requestOptions);
        const data = await response.json();
