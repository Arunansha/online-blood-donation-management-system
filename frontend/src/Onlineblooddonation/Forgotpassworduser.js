...
function Forgotpassworduser() {
    ...
    const validateEmail = async () => {
        ...
        const response = await fetch('https://online-blood-donation-backend.onrender.com/validateEmailUser', requestOptions);
    ...
    const sentpass = async () => {
        ...
        const response = fetch('https://online-blood-donation-backend.onrender.com/send-email', requestOptions);
        const data = response;
        setMessage(data);
