...
function Search() {
    ...
    const getData = async () => {
        const response = await fetch('https://online-blood-donation-backend.onrender.com/getAllDonors');
        ...
        if (val == null || val == "") {
            ...
            const searchbyBloodgroup = async (value) => {
                ...
                if (value == null || value == "") {
                    ...
                    const response = await fetch(`https://online-blood-donation-backend.onrender.com/SearchbyBloodgroup/${value}`)
            ...
            const response = await fetch('https://online-blood-donation-backend.onrender.com/searchboth', requestOptions)
            const data = await response.json();
            setAlldonors(data)
            console.log(data);
        }
    ...
    const searchDonor = async (value) => {
        if (value == null || value == "") {
            ...
            const response = await fetch(`https://online-blood-donation-backend.onrender.com/searchbyaddress/${value}`)
            const data1 = await response.json()
            setAlldonors(data1)
        }
    }
