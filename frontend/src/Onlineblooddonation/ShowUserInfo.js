...
function ShowUserInfo() {
  ...
  const getData = async () => {
    const response = await fetch('https://online-blood-backend.onrender.com/getAllUsers');
  ...
  const deleteUser = async (id) => {
    ...
    if (window.confirm("are you sure want to delete?")); {
      ...
      const response = await fetch(`https://online-blood-backend.onrender.com/deleteUser/${id}`, requestOptions);
